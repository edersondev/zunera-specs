...
2. Configure the database, DB session/cache/queue, SMTP, `FRONTEND_URL`, credentialed CORS origins, and Sanctum stateful domains through environment variables.
