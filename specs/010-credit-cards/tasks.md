...
- [ ] T010 Implement mutation idempotency storage, request fingerprinting, replay behavior, and lock ordering in `/home/ederson/workspace/zunera/zunera-backend/app/Services/CreditCards/CreditCardMutationIdempotencyService.php` and `/home/ederson/workspace/zunera/zunera-backend/app/Exceptions/CreditCards/`.
...
- [ ] T023 [P] [US1] Add card list, detail, create, update, archive, stable `Idempotency-Key` generation, and safe replay-retry API-service tests in `/home/ederson/workspace/zunera/zunera-frontend/tests/unit/services/creditCardService.spec.js`.
...
- [ ] T025 [US1] Implement card API access, stable per-mutation `Idempotency-Key` reuse for retry/replay, and state orchestration in `/home/ederson/workspace/zunera/zunera-frontend/src/services/creditCardService.js` and `/home/ederson/workspace/zunera/zunera-frontend/src/stores/credit-cards/creditCardStore.js`.
...
- [ ] T028 [P] [US2] Write one-time purchase, closing-day assignment, archived-card rejection, typed over-limit confirmation-required/retry flow with exact negative availability, and no-account-balance-movement coverage in `/home/ederson/workspace/zunera/zunera-backend/tests/Feature/CreditCards/CreditCardPurchaseTest.php`.
...
- [ ] T036 [P] [US2] Add purchase submission/retry with stable idempotency key, installment preview, category failure, and assigned-statement client tests in `/home/ederson/workspace/zunera/zunera-frontend/tests/unit/services/creditCardService.spec.js` and `/home/ederson/workspace/zunera/zunera-frontend/tests/unit/stores/creditCardStore.spec.js`.
...
- [ ] T040 [US2] Add browser coverage for single/installment purchases, closing-day messaging, over-limit confirmation/retry, and unchanged paying-account balance in `/home/ederson/workspace/zunera/zunera-frontend/tests/e2e/credit-cards/credit-card-purchases.spec.js`.
...
- [ ] T051 [P] [US3] Add statement query, partial-payment retry with stable idempotency key, state, and payment-history reload tests in `/home/ederson/workspace/zunera/zunera-frontend/tests/unit/services/creditCardService.spec.js` and `/home/ederson/workspace/zunera/zunera-frontend/tests/unit/stores/creditCardStore.spec.js`.
